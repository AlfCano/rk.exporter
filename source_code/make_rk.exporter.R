local({
  ...
  # =========================================================================================
  # COMPONENT 1: Batch Plot Exporter (ggplot2)
  # =========================================================================================
  help_plt <- rk.rkh.doc(title = rk.rkh.title("Batch Plot Exporter"), summary = rk.rkh.summary("Exports a list of ggplot2 objects to individual files or a combined document (PDF, Word, PPTX)."))
  ...
  # =========================================================================================
  # COMPONENT 2: Batch Table Exporter (flextable)
  # =========================================================================================
  help_tbl <- rk.rkh.doc(title = rk.rkh.title("Batch Table Exporter"), summary = rk.rkh.summary("Exports a list of flextable objects to individual files or a combined document (Word, PPTX)."))
  ...
  cat("\nPlugin 'rk.exporter' generated successfully.\n")
})
